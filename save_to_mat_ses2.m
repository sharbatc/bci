function data = save_to_mat(header, labels, channels, eye_channels, biceps_channels, cleared_trigger_ses2, fName)
...
for i=1:15
	[channels_, eye_channels_, biceps_channels_, trigger_] = slice_trial(i, channels, eye_channels, biceps_channels, cleared_trigger_ses2);
